...
[![GitHub stars](https://img.shields.io/github/stars/data-scrape/amazon-scraper-api?style=social)](https://github.com/data-scrape/amazon-scraper-api)
[![GitHub forks](https://img.shields.io/github/forks/data-scrape/amazon-scraper-api?style=social)](https://github.com/data-scrape/amazon-scraper-api/fork)
[![GitHub issues](https://img.shields.io/github/issues/data-scrape/amazon-scraper-api)](https://github.com/data-scrape/amazon-scraper-api/issues)
[![GitHub license](https://img.shields.io/github/license/data-scrape/amazon-scraper-api)](https://github.com/data-scrape/amazon-scraper-api/blob/main/LICENSE)
...
```bash
pip install git+https://github.com/data-scrape/amazon-scraper-api.git
```

### From source

```bash
git clone https://github.com/data-scrape/amazon-scraper-api.git
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/data-scrape/amazon-scraper-api)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/data-scrape/amazon-scraper-api/issues) if you find a bug
...
[![Star History](https://img.shields.io/github/stars/data-scrape/amazon-scraper-api?style=social)](https://github.com/data-scrape/amazon-scraper-api)
