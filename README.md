...
[![GitHub stars](https://img.shields.io/github/stars/xiaozhucchongya-byte/amazon-scraper-api?style=social)](https://github.com/xiaozhucchongya-byte/amazon-scraper-api)
[![GitHub forks](https://img.shields.io/github/forks/xiaozhucchongya-byte/amazon-scraper-api?style=social)](https://github.com/xiaozhucchongya-byte/amazon-scraper-api/fork)
[![GitHub issues](https://img.shields.io/github/issues/xiaozhucchongya-byte/amazon-scraper-api)](https://github.com/xiaozhucchongya-byte/amazon-scraper-api/issues)
[![GitHub license](https://img.shields.io/github/license/xiaozhucchongya-byte/amazon-scraper-api)](https://github.com/xiaozhucchongya-byte/amazon-scraper-api/blob/main/LICENSE)
[![Python](https://img.shields.io/badge/Python-3.8+-blue?logo=python)](https://www.python.org/)

</div>


> Amazon scraper API - REST API for Amazon data extraction


<!-- SEO keywords: amazon scraper api, Amazon Scraper Api, amazon scraper api python, amazon scraper api github, best amazon  api scraper -->
...
- RESTful API for Amazon data extraction
- Endpoints for products, reviews, prices, and search
...
Build Amazon data services, integrate Amazon data into your application, provide Amazon scraping as a service, or build internal data pipelines.
...
| GET | `/api/v1/reviews/{asin}` | Get product reviews |
| GET | `/api/v1/price/{asin}` | Get price history |
| GET | `/api/v1/search?q={query}` | Search Amazon |
...
python -m amazon_scraper_api --port 8000

# Query the API
curl http://localhost:8000/api/v1/product/B08N5WRWNW
# Returns: {"asin": "...", "title": "...", "price": 29.99, ...}
```
...
```bash
pip install git+https://github.com/xiaozhucchongya-byte/amazon-scraper-api.git
```

### From source

```bash
git clone https://github.com/xiaozhucchongya-byte/amazon-scraper-api.git
...
from amazon_scraper_api import Scraper
...
python -m amazon_scraper_api --query "your-query" --output results.json
```
...
### Is Amazon Scraper Api legal to use?
...
### Do I need to login to use amazon scraper api?
...
### Will I get banned for using amazon scraper api?
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/xiaozhucchongya-byte/amazon-scraper-api)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/xiaozhucchongya-byte/amazon-scraper-api/issues) if you find a bug
...
[![Star History](https://img.shields.io/github/stars/xiaozhucchongya-byte/amazon-scraper-api?style=social)](https://github.com/xiaozhucchongya-byte/amazon-scraper-api)
